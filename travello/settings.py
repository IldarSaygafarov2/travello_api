...
CSRF_TRUSTED_ORIGINS = ["https://travella-admin.uz"]
...
TG_SEND_DOCUMENT_URL = "https://api.telegram.org/bot{token}/sendDocument?chat_id={channel_id}&document={document}&caption={caption}"
