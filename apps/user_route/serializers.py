...
class UserRouteGuideSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["user_route", "guide", "guide_route", "date_from", "date_to"]
...
class UserRouteCreateSerializer(serializers.ModelSerializer):
    ...
    additional_services = UserRouteAdditionalServiceSerializer(
